function setStage(){
	...
	if(ww.stage == 6){ ww.mobs = [objMobDestroyer, objMobDestroyer, objMobDestroyer, objMobDestroyer, objMobCruiser]; }
	...
	if(ww.stage == 9){ ww.rockRate = 100; ww.mobs = [objMobCruiser2, objMobDestroyer, objMobDestroyer, objMob, objMob, objMobCruiser2, objMob, objMob, objMob, objMobCruiser, objMobCruiser2, objMobCruiser]; }
	if(ww.stage >= 10){ ww.mobs = [objMobCruiser, objMobFighter2, objMobFighter2, objMobFighter2, objMobFighter2, objMobFighter2, objMobFighter2, objMobFighter2, objMobDestroyer, objMobDestroyer, objMobDestroyer]; }
